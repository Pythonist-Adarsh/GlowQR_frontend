          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-[#1D9E75] focus:border-transparent transition-all outline-none"
              />
            </div>
          </div>
          <div>
        ...
        <form onSubmit={handlePasswordSubmit} className="space-y-6 max-w-lg">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all outline-none"
            />
          </div>
          <div>
